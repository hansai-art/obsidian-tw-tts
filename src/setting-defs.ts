...
export function coreSettingDefs(voices: VoiceLike[]): SettingDefinitionControl[] {
	return [
		...
		{
			name: STRINGS.settingPitch,
			desc: STRINGS.settingPitchDesc,
			control: {
				type: 'slider',
				key: 'pitch',
				min: -10,
		...
		{
			name: STRINGS.settingSilentSymbols,
			desc: STRINGS.settingSilentSymbolsDesc,
			control: {
				type: 'text',
				key: 'silentSymbols',
				placeholder: STRINGS.settingSilentSymbolsPlaceholder,
			},
		},
	];
}
